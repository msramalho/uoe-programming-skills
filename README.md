 ...
 * the [lib](code/lib/) contains the provided `arralloc` and `uni` library functions and are isolated from the main code
...
`make realclean && make && ./main.out -r 0.5 -g 7 -m 2`
